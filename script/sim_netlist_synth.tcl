...
if {$target == 0} {
	...
	vsim -L /software/dk/nangate45/verilog/msim6.2g -sdftyp /test_bench/DUT=../netlist/riscv.sdf work.test_bench
	run 1400 ns
	...
	vlog -work ./work ../netlist/riscv_SPECIAL.v
	vcom -93 -work ./work ../tb/test_bench.vhd
	vsim -L /software/dk/nangate45/verilog/msim6.2g -sdftyp /test_bench/DUT=../netlist/riscv_SPECIAL.sdf work.test_bench
	run 1400 ns
}
